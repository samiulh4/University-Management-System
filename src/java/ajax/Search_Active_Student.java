...
public class Search_Active_Student extends HttpServlet {// Search_Active_Student Class Start.
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String student_id = request.getParameter("student_id1");
        String status = null;
        if (student_id == null || student_id.trim().equals("")) {
            ...
            if (!student_essential_dao.studentActive(student_id)) {
                out.print("<thead>");
                out.print("<tr>");
                out.print("<th style='color:red'>Student ID Not Found Or Not Active.</th>");
                out.print("</tr>");
                out.print("</thead>");
            } else {
                try {
                    ...
                    if (student_essential_info.getStudent_status().equals("1")){status ="Active";}
